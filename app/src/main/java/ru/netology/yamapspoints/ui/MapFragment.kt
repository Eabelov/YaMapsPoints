...
import ru.netology.yamapspoints.databinding.FragmentMapBinding
import ru.netology.yamapspoints.databinding.PointBinding
                ...
                repeatOnLifecycle(Lifecycle.State.STARTED) {
                    viewModel.points.collectLatest { points ->
                        ...
                        points.forEach { point ->
                            ...
                            pointBinding.type.setImageResource(R.drawable.ic_point_24)
